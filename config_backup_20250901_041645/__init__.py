...
from .core import (
    # 網格參數
    NX, NY, NZ, DX, DT, PHYSICAL_DOMAIN_SIZE, SCALE_LENGTH, SCALE_TIME, SCALE_VELOCITY, GRID_SIZE_CM,
...
# 重要：TAU_WATER 向後兼容性別名
TAU_WATER = TAU_FLUID  # UnifiedLBMSolver 和其他模組需要此參數
